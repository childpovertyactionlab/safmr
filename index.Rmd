...
* Small Area Fair Market Rent estimates from the Department of Housing and Urban Development for Q1 2022
...
rent.labels <- c("Less than SAFMR",
                 "No Greater than $250 SAFRM",
                 "Greater than $250 SAFRM")
...
popupRent <- paste0("<b>", "Zip Code: ", "</b>", safmr$GEOID, "<br>",
                "<b>", "Total Multi-Family CoStar: ", "</b>", safmr$TotMF, "<br>",
                "<b>", "Fair Market Rent 2-Bedroom: ", "</b>", "$", safmr$FairMrkt2BR, "<br>",
                "<b>", "Medium Rent 2-Bedroom: ", "</b>", "$", safmr$medRent2BR, "<br>",
